...
; used by PokemonActionSubmenu (see engine/pokemon/mon_menu.asm)
	...
	const MONMENUITEM_DIG        ; 6
	const MONMENUITEM_TELEPORT   ; 7
	const MONMENUITEM_SOFTBOILED ; 8
	const MONMENUITEM_HEADBUTT   ; 9
	const MONMENUITEM_ROCKSMASH  ; 10
	const MONMENUITEM_MILKDRINK  ; 11
	const MONMENUITEM_SWEETSCENT ; 12
	; options
