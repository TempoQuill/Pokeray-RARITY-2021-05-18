...
; entries correspond to EMAIL_* constants
	phone TRAINER_NONE, EMAIL_00,              N_A,                       0,       UnusedPhoneScript,        0,       UnusedPhoneScript
	phone TRAINER_NONE, EMAILCONTACT_MOM,      PLAYERS_HOUSE_1F,          ANYTIME, MomPhoneCalleeScript,     0,       UnusedPhoneScript
	phone TRAINER_NONE, EMAILCONTACT_BIKESHOP, N_A,                       0,       UnusedPhoneScript,        0,       UnusedPhoneScript
	phone TRAINER_NONE, EMAILCONTACT_BILL,     N_A,                       ANYTIME, BillPhoneCalleeScript,    0,       BillPhoneCallerScript
	phone TRAINER_NONE, EMAILCONTACT_ELM,      N_A,                       ANYTIME, ElmPhoneCalleeScript,     0,       ElmPhoneCallerScript
	phone TRAINER_NONE, EMAILCONTACT_LARCH,    LARCHS_LAB,                ANYTIME, UnusedPhoneScript,        0,       UnusedPhoneScript
