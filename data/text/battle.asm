...
BattleText_PlayerPickedUpPowerBallMoney:
	text "The POWER BALL(S)"
	line "awarded ¥@"
	text_decimal wPowerBallMoney, 3, 6
	text "!"
	prompt
...
BellChimedText:
	text "A bell chimed!"
	line "The party's status"
	cont "problems have been"
	cont "eliminated!"
	prompt
