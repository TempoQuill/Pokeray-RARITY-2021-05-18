...
; improved accuracy
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,        70, 20,   0 ;
...
; reduced accuracy
	move EXPLOSION,    EFFECT_SELFDESTRUCT,      250, NORMAL,        80,  5,   0 ;
...
; reduced accuracy
	move TRI_ATTACK,   EFFECT_TRI_ATTACK,         80, NORMAL,        90, 10,  20 ;
...
; reduced accuracy
	move POWDER_SNOW,  EFFECT_FREEZE_HIT,         40, ICE,           90, 25,  10 ;
...
; drops physical rather than special
	move SHADOW_BALL,  EFFECT_DEFENSE_DOWN_HIT,   80, GHOST,        100, 15,  20 ;
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,       80, PSYCHIC_TYPE,  90, 15,   0
; guaranteed to drop defense
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   20, FIGHTING,     100, 15, 100 ;
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        15, WATER,         70, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,         100, 10,   0
	move BASE_SPORE,   EFFECT_BURN,                0, GRASS,         75, 20,   0
	move BITTER_BITE,  EFFECT_FREEZE,              0, ICE,           30,  5,   0
	move FUNNY_STUFF,  EFFECT_FUNNY_STUFF,         1, NORMAL,        90, 10,  35
