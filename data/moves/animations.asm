...
; entries correspond to constants/move_constants.asm
	...
	dw BattleAnim_BaseSpore
	dw BattleAnim_BitterBite
	dw BattleAnim_FunnyStuff
...
; $100
	...
	dw BattleAnim_ThrowAndMiss
	dw BattleAnim_RowdyHit
...
BattleAnim_HiJumpKick:
	anim_1gfx ANIM_GFX_HIT
	anim_bgeffect ANIM_BG_1F, $40, $2, $0
	anim_if_param_equal $1, BattleAnim_RowdyHit
	anim_wait 32
	anim_sound 0, 1, SFX_JUMP_KICK
	anim_obj ANIM_OBJ_07, 112, 72, $0
	anim_setobj $1, $2
...
BattleAnim_Smokescreen:
	...
	anim_wait 8
.loop
	anim_sound 0, 1, SFX_SMOKESCREEN
