...
.scroll_page_down
	ld hl, wPokegearPhoneScrollPosition
	ld a, [hl]
	cp CONTACT_LIST_SIZE - EMAIL_DISPLAY_HEIGHT
	ret nc
	inc [hl]
	jr .done_joypad_update_page
...
INCLUDE "data/maps/demo/flypoints.asm"
