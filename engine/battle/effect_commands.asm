...
.Rowdy:
	...
	; High jump kick miss animation plays
	ld de, ANIM_ROWDY_HIT
	ld a, BATTLE_VARS_SUBSTATUS3_OPP
	call GetBattleVar
	and 1 << SUBSTATUS_FLYING | 1 << SUBSTATUS_UNDERGROUND
	call z, PlayFXAnimID
