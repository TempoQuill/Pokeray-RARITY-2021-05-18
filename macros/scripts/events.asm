...
ENDM
	...
	const addmailaddr_command ; $28
addmailaddr: MACRO
	db addmailaddr_command
	db \1 ; person
ENDM

	const delmailaddr_command ; $29
delmailaddr: MACRO
	db delmailaddr_command
	db \1 ; person
ENDM

	const checkmailaddr_command ; $2a
checkmailaddr: MACRO
	db checkmailaddr_command
	db \1 ; person
ENDM
...
ENDM
	...
	const askforemailaddr_command ; $96
askforemailaddr: MACRO
	db askforemailaddr_command
	db \1 ; number
ENDM

	const email_command ; $97
email: MACRO
	db email_command
	dw \1 ; caller_name
ENDM

	const endofmessage_command ; $98
endofmessage: MACRO
	db endofmessage_command
ENDM
...
ENDM
	...
	const specialemail_command ; $9b
specialemail: MACRO
	db specialemail_command
	dw \1 ; call_id
ENDM

	const checkemail_command ; $9c
checkemail: MACRO
	db checkemail_command
ENDM
